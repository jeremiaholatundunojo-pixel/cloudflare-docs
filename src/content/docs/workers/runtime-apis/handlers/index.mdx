...
When you [write Workers in Python](/workers/languages/python/), handlers are placed in a class named `Default` that extends the `WorkerEntrypoint` class (which you can import from the `workers` SDK module).
